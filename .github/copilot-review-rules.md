...
- **Checks:**
  ...
  - Verify action contracts: `action.yml` inputs, `INPUT_*` env vars, and `output-path` output.
  - Validate JSON/schema-ish outputs stay stable unless explicitly changed.
