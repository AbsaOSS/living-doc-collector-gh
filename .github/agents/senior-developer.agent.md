...
Inputs
- Issue/PR description and acceptance criteria, docs updates proposed by Specification Master, test plans from SDET, PR feedback from Reviewer.
...
Collaboration
- Clarify acceptance criteria and contract surfaces (inputs/outputs) with Specification Master before coding.
