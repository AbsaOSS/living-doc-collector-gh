...
#
#
# def test_fetch_github_issues_success(mocker, config_repository, repository_setup, living_documentation_generator):
#     mocker.patch(
...
#         living_documentation_generator._LivingDocumentationGenerator__github_instance,
#         "get_repo",
